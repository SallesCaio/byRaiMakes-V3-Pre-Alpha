...
describe('AgendePage (H0.9.2 checkout visitante)', () => {
  ...
  it('confirmarPedido monta a mensagem WhatsApp sem incluir o mimo como item', async () => {
    const page = make();
    ...
    page.itens = [
      {
        id: 'p1',
        nome: 'Gloss Mágico Coelho Vivai',
        preco: 18,
        img: '',
        qtd: 1
      }
    ...
    expect(msg).not.toContain('Um carinho especial (x1)');
